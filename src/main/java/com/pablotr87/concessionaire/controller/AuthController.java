...
public class AuthController {
    ...
    public String getLogin(@RequestParam(value = "error", required = false) String errorCode,
                           Model model) {
     ...
     */
    private void checkErrorCode(String errorCode, Model model) {
        if (null != errorCode) {
            switch (errorCode) {
    ...
    public String postSignUp(@ModelAttribute(MDL_USER) UserBean user,
                             Errors errors,
                             Model model) {
    ...
    /**
     * Mapping for returning logout page.
     * @param request
     * @param response

package com.pablotr87.concessionaire.validator;
...
public class UserValidator implements Validator {
    ...
    public void validate(Object obj, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, USERNAME_FIELD,
                MSG_MANDATORY_FIELD);
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, EMAIL_FIELD,
                MSG_MANDATORY_FIELD);
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, PSWD_FIELD,
                MSG_MANDATORY_FIELD);
